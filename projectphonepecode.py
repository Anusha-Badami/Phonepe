...
def ques1():
    ...
    fig_sa= px.bar(sa2, x= "States", y= "AppOpens", title="Top States With AppOpens",
                color_discrete_sequence= px.colors.sequential.Mint_r)
...
def ques4():
    ...
    fig_htd= px.pie(htd2, values= "Transaction_amount", names= "Districts", title="TOP 20 DISTRICTS OF LOWEST TRANSACTION AMOUNT",
...
def ques9():
    ...
    fig_lts= px.bar(ht2, x= "States", y= "Transaction_amount",title= "Top 30 States with highest transaction amount",
...
if select == "Home":
    ...
    with col4:
        ...
        st.write("****Pay through Direct Transfer & More****")
        st.write("****Pay through QR Code****")
    ...
    with col6:
        st.image("C:\\Users\\Anusha Badami\\Pictures\\PhonePeimage.jpg")
...
if select == "Top Charts":
    ...
    ques= st.selectbox("**Select the Question**",('Top States With AppOpens','States With Lowest Trasaction Amount',
                                  'Top 10 Districts With Highest Transaction Amount','Top 20 Districts With Lowest Transaction Amount',
                                  'Top 10 States With AppOpens','Least 10 States With AppOpens','States With Lowest Trasaction Count',
                                 'States With Highest Trasaction Count','Top 30 States With Highest Trasaction Amount',
    ...
    elif ques=="Top 20 Districts With Lowest Transaction Amount":
        ques4()
    ...
    elif ques=="Top 30 States With Highest Trasaction Amount":
        ques9()
